                                        ...
                                        <tr>
                                            <td style="text-align: left">
                                                <asp:ImageButton ID="ImageButton4" runat="server" 
                                                    ImageUrl="~/images/prevlabel.gif" onclick="ImageButton4_Click" Height="80px"  Width="200px"/>
                                            </td>
                                            <td>
                                                &nbsp;</td>
                                            <td style="text-align: right">
                                                <asp:ImageButton ID="ImageButton5" runat="server" 
                                                    ImageUrl="~/images/nextlabel.gif" onclick="ImageButton5_Click" Height="80px"  Width="200px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td style="text-align: right">
                                                <asp:ImageButton ID="ImageButton6" runat="server" 
                                                    ImageUrl="~/images/closelabel.gif" onclick="ImageButton6_Click" Height="80px"  Width="200px"/>
                                            </td>
                                        </tr>
                                    </table>
                                    <br />
