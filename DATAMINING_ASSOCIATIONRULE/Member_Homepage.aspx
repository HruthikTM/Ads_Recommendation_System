<%@ Page Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="Member_Homepage.aspx.cs" Inherits="DATAMINING_ASSOCIATIONRULE.Member_Homepage" Title="Untitled Page" %>
      ...
      <section class="inner_page_head">
         <div class="container_fuild">
            <div class="row">
               <div class="col-md-12">
                  <div class="full">
                     <h3>Welcome member - YOUR BUYING PATTERNS (APRIORI)</h3>
                  </div>
               </div>
            </div>
         </div>
